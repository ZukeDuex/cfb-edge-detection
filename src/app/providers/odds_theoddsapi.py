...
class OddsAPIClient:
    ...
    @staticmethod
    def _in_season_week(
        commence_time: datetime, season: int, week: Optional[int]
    ) -> bool:
        """Return True if commence_time occurs in the given season and optional ISO week."""
        if commence_time.year != season:
            return False
        if week is not None and commence_time.isocalendar().week != week:
            return False
        return True
            ...
            for period in periods:
                try:
                    ...
                    for game in data:
                        ...
                        if not self._in_season_week(commence_time, season, week):
                            continue
                                        ...
                                        odds_data.append(
                                            {
                                                ...
                                                "season": season,
                                                "week": week
                                                or commence_time.isocalendar().week,
                                                "season_type": "regular",
                                                "period": period,
                                                "market": market,
                                                "book": book,
